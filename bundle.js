...
var _statsJs = __webpack_require__(6);
...
var _framework = __webpack_require__(0);
...
function WebGL2() {
    ...
    this.createPrograms = function (fileNames) {
        ...
        for (var i = 0; i < fileNames.length; i++) {
            ...
            var vertexShaderSource = __webpack_require__(12)("./" + fileNames[i] + '-vert.glsl');
            var fragmentShaderSource = __webpack_require__(11)("./" + fileNames[i] + '-frag.glsl');
